...
sidneys_five_bar_long_island_ice_tea = BarCocktail.create(bar_id: sidneys_five_bar.id, cocktail_id: long_island_ice_tea.id)
...
nobodys_darling_bar_long_island_ice_tea = BarCocktail.create(bar_id: nobodys_darling_bar.id, cocktail_id: long_island_ice_tea.id)
...
thunderbolt_bar_long_island_ice_tea = BarCocktail.create(bar_id: thunderbolt_bar.id, cocktail_id: long_island_ice_tea.id)
...
everson_royce_bar_long_island_ice_tea = BarCocktail.create(bar_id: everson_royce_bar.id, cocktail_id: long_island_ice_tea.id)
...
five_points_bar_long_island_ice_tea = BarCocktail.create(bar_id: five_points_bar.id, cocktail_id: long_island_ice_tea.id)
...
dento_union_bar_long_island_ice_tea = BarCocktail.create(bar_id: dento_union_bar.id, cocktail_id: long_island_ice_tea.id)
...
springwater_bar_long_island_ice_tea = BarCocktail.create(bar_id: springwater_bar.id, cocktail_id: long_island_ice_tea.id)
...
patterhouse_house_long_island_ice_tea = BarCocktail.create(bar_id: patterhouse_house.id, cocktail_id: long_island_ice_tea.id)
...
Review.create(stars: 5, comment: "My favorite one around", user_id: user1.id, bar_cocktail_id: basik_bar_old_fashioned.id)
Review.create(stars: 4, comment: "Not the best but very very good", user_id: user1.id, bar_cocktail_id: ore_bar_mojito.id)
Review.create(stars: 3, comment: "Eh not good but not bad", user_id: user1.id, bar_cocktail_id: ore_bar_long_island_ice_tea.id)
Review.create(stars: 5, comment: "Can't beat this cosmo", user_id: user1.id, bar_cocktail_id: basik_bar_cosmopolitan.id)
Review.create(stars: 5, comment: "My favorite one of all!", user_id: user1.id, bar_cocktail_id: blinkys_bar_caipirinha.id)

puts "----- seeding 5 reviews for user2"
Review.create(stars: 5, comment: "My favorite one around", user_id: user2.id, bar_cocktail_id: sunken_harbor_club_bar_old_fashioned.id)
Review.create(stars: 4, comment: "Not the best but decent", user_id: user2.id, bar_cocktail_id: mace_bar_cosmopolitan.id)
Review.create(stars: 3, comment: "Ehhhh", user_id: user2.id, bar_cocktail_id: attaboy_bar_caipirinha.id)
Review.create(stars: 5, comment: "Can't beat this one! Delicious", user_id: user2.id, bar_cocktail_id: sekend_sun_caipirinha.id)
Review.create(stars: 5, comment: "My favorite one of all!", user_id: user2.id, bar_cocktail_id: the_bonnie_bar_long_island_ice_tea.id)

puts "----- seeding 5 reviews for user3"
Review.create(stars: 5, comment: "My favorite old fashioned around", user_id: user3.id, bar_cocktail_id: nobodys_darling_bar_mojito.id)
Review.create(stars: 4, comment: "Not the best but very very good", user_id: user3.id, bar_cocktail_id: carols_pub_cosmopolitan.id)
Review.create(stars: 3, comment: "Eh not good but not bad", user_id: user3.id, bar_cocktail_id: melody_bar_mojito.id)
Review.create(stars: 5, comment: "Can't beat this mojito!!!", user_id: user3.id, bar_cocktail_id: sobre_mesa_bar_mojito.id)
Review.create(stars: 5, comment: "My favorite one of all!", user_id: user3.id, bar_cocktail_id: dento_union_bar_old_fashioned.id)

puts "----- seeding 5 reviews for user4"
Review.create(stars: 5, comment: "My favorite one around", user_id: user4.id, bar_cocktail_id: springwater_bar_old_fashioned.id)
Review.create(stars: 4, comment: "Not the best but very very good", user_id: user4.id, bar_cocktail_id: henley_bar_caipirinha.id)
Review.create(stars: 3, comment: "Eh not good but not bad", user_id: user4.id, bar_cocktail_id: patterhouse_house_cosmopolitan.id)
Review.create(stars: 5, comment: "Can't beat this old fashioned", user_id: user4.id, bar_cocktail_id: baby_gee_bar_old_fashioned.id)
Review.create(stars: 5, comment: "My favorite one of all!", user_id: user4.id, bar_cocktail_id: baby_gee_bar_caipirinha.id)

puts "----- seeding 5 reviews for user5"
Review.create(stars: 5, comment: "My favorite one around", user_id: user5.id, bar_cocktail_id: aero_club_old_fashioned.id)
Review.create(stars: 4, comment: "Not the best but very very good", user_id: user5.id, bar_cocktail_id: five_points_bar_old_fashioned.id)
Review.create(stars: 3, comment: "Eh not good but not bad", user_id: user5.id, bar_cocktail_id: belemans_bar_mojito.id)
Review.create(stars: 5, comment: "Can't beat this cosmo", user_id: user5.id, bar_cocktail_id: sidneys_five_bar_caipirinha.id)
Review.create(stars: 5, comment: "My favorite one of all!", user_id: user5.id, bar_cocktail_id: the_bonnie_bar_old_fashioned.id)
